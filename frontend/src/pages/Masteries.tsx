...
const Select: React.FC<{options: Array<{label: string, value: string}>; value: string; onChange: React.Dispatch<React.SetStateAction<string>>; placeholder: string; classes?: string;}> = ({options, value, onChange, placeholder, classes}) => {
    ...
    return (
        <div className="container m-auto">
            ...
            <div className="text-neutral-50">
                ...
                <div className="flex justify-between items-center bg-neutral-800 w-full my-2 p-2 gap-2">
                    <div className="flex gap-2">
                        <Select options={masteryOptions} value={masteryFilter} onChange={setMasteryFilter} placeholder="Mastery points" classes="w-[250px] text-white" />
                        <Select options={championsOptions} value={championsFilter} onChange={setChampionsFilter} placeholder="All champions" classes="w-[250px] text-white" />
                    </div>

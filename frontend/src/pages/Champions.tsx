            ...
            <div className="w-full bg-neutral-800 mt-1">
                ...
                <div className="p-2">
                    <ul className="flex gap-10 p-2">
                        ...
                        <li><Link to={`/lol/profile/${regionCode}/${encodedSummoner}/champions`} state={{apiData: apiData}} className="cursor-pointer pt-3 pb-3 pl-5 pr-5 rounded transition-all duration-150 ease-in hover:bg-neutral-600 bg-neutral-700 border text-purple-400 hover:text-neutral-100">Champions</Link></li>
